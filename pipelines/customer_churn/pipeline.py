...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://sagemaker-us-east-1-904010800562/sagemaker/DEMO-xgboost-churn/data/RawData.csv",  # Change this to point to the s3 location of your raw input data.
    )
